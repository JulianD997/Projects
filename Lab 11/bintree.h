...
class binary_tree_node
{
	...
	Item max_val(binary_tree_node<Item> *root);
	Item tree_sum(binary_tree_node<Item> *root);
	Item node_count(binary_tree_node<Item> *root);
	Item tree_average(binary_tree_node<Item> *root);
